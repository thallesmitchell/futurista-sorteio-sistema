  ...
  return (
    <div className="min-h-screen flex bg-background relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none">
        ...
        <div className="absolute bottom-[15%] right-[8%] w-80 h-80 rounded-full bg-accent/10 blur-3xl"></div>
        <div className="absolute top-[40%] right-[20%] w-40 h-40 rounded-full bg-primary/5 blur-2xl"></div>
      </div>
        ...
        <div className={cn("container mx-auto")}>
          <div className="mb-4 flex items-center">
            <img 
              ...
              alt="Pix Acumulado" 
              className="h-12 md:h-16 mr-2 animate-glow"
            />
          </div>
