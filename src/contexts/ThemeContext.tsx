...
export function ThemeProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    ...
    style.innerHTML = `
      ...
      /* Override para evitar fontes serifadas */
      * {
        font-family: 'Inter', -apple-system, BlinkMacSystemFont, system-ui, sans-serif !important;
      }
      
      /* Garantir que as cores do tema sejam aplicadas com alta prioridade */
      :root {
  ...
  const generatePalette = (baseColor: string) => {
    ...
    const { h } = hexToHSL(palette.primaryColor);
    document.documentElement.style.setProperty('--primary', `${h} 100% 54%`, 'important');
  };
