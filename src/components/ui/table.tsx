...
>(({ className, ...props }, ref) => (
  <div className="relative w-full overflow-auto rounded-lg border border-primary/20">
    <table
      ref={ref}
...
>(({ className, ...props }, ref) => (
  <thead ref={ref} className={cn("bg-muted/50 backdrop-blur-sm", className)} {...props} />
))
